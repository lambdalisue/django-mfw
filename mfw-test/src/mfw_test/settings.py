# Django settings for mobilejp_test project.
import sys
import os.path
ROOT = os.path.join(os.path.dirname(__file__), r'../../')
...
SECRET_KEY = 'l9yox09%888p617a24wzoc3vw%u__yu@h4h5d@%5gbsf7ooe7^'

# List of callables that know how to import templates from various sources.
TEMPLATE_LOADERS = (
    'mfw.template.loaders.flavour.Loader',
    # the mfw's flavour template loader has to be first
